                ...
                @forelse ($lesson -> videos -> sortBy('number') as $video)
                    <div class="col-sm-3 mb-3">
                        @php 
                            ...
                            if (count($codevideo) > 4) {
                                $codevideoparam = explode('?', $codevideo[4])[0];
                            } else {
                                $codevideoparam = 'a3bf0affdd';
                            }
                        @endphp
                        <div class="ratio ratio-16x9">
                            <iframe class="rounded-4" src="https://player.vimeo.com/video/{{ $codevideo[3] }}?h={{ $codevideoparam }}&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                            <div>
